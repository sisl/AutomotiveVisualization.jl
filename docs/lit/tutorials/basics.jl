...
# If the value of `AutomotiveVisualization.rendermode` is set to `:basic`, entities are simply
...
#
# Setting `AutomotiveVisualization.rendermode` to `:fancy`, the rectangles are replaced by SVG
